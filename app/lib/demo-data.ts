...
export const requirements: Requirement[] = [
  ...
  },
  {
    ...
    specCompletion: 100,
    owners: { product: "顾言", development: "赵屿", testing: "周祺" },
    counts: { prototypes: 4, documents: 3, tasks: 8, changes: 19, tests: 48 },
    updatedAt: "3 周前",
    createdAt: "2 月前",
    createdBy: "顾言",
  },
  {
    ...
    specCompletion: 100,
    owners: { product: "陈楠", development: "林川", testing: "周祺" },
    counts: { prototypes: 6, documents: 2, tasks: 11, changes: 27, tests: 63 },
    updatedAt: "2 月前",
    createdAt: "4 月前",
    createdBy: "陈楠",
  },
  {
    ...
    code: "REQ-016",
    title: "权限审计基础能力",
    summary: "统一记录成员、角色和资源权限的关键变更",
    stage: "done",
    gateStatus: "approved",
    gateLabel: "已完成上线验收",
    specVersion: "v1.5",
    specCompletion: 100,
    owners: { product: "陈楠", development: "赵屿", testing: "周祺" },
    counts: { prototypes: 2, documents: 3, tasks: 9, changes: 22, tests: 51 },
    updatedAt: "5 月前",
    createdAt: "7 月前",
    createdBy: "陈楠",
  },
